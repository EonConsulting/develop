...
<input type='submit' name='submit' value="Send Grade (9.2)">
<input type='submit' name='submit' value="Read Grade (after send) (9.3)">
<input type='submit' name='submit' value="Delete Grade (9.4)">
<input type='submit' name='submit' value="Check Grade (after delete) (9.5)">
<input type='submit' name='submit' value="Test Unsupported Operation (9.6)">
<input type='submit' name='submit' value="Out-of-range test (9.7)">
<input type='submit' name='submit' value="Non-numeric (9.8)">

<br/>
You can run the tests as many times as you like, to pass test 9.3, it should be run right after 9.2 and
to pass test 9.4 it should be run after 9.3.
</form>
<?php
$url = $_REQUEST['url'];
...
if ( strpos($_POST['submit'], "Test") === 0 && $code_major == 'unsupported' ) {
   mark_pass("9.6", "Handles invalid operations");
}

if ( strpos($_POST['submit'], "Out") === 0 && $code_major == 'failure' ) {
   mark_pass("9.7", "Handles out of range values with failure");
}

if ( strpos($_POST['submit'], "Non") === 0 && $code_major == 'failure' ) {
   mark_pass("9.8", "Handles non-numeric values");
}
