...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(url('/vendor/MindMap/img/favicon.ico')); ?>" />
    <link rel="stylesheet" href="<?php echo e(url('/vendor/MindMap/css/common.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('/vendor/MindMap/css/app.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('/vendor/MindMap/css/Aristo/jquery-ui-1.8.7.custom.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(url('/vendor/MindMap/css/minicolors/jquery.miniColors.class')); ?>">
