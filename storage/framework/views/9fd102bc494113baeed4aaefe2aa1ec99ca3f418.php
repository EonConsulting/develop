        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">Categories <a href="<?php echo e(route('eon.laravellti.cats.create')); ?>" class="btn btn-primary btn-xs"><span class="fa fa-plus"></span></a><div class="col-md-6 pull-right"><input type="text" id="txt_search" class="form-control" onkeyup="search()" placeholder="Search Categories.."></div><div class="clearfix"></div></div>
                    <table class="panel-body table table-hover table-striped" id="courses-table">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($category->creator['name']); ?></td>
                                <td><?php echo e($category['created_at']); ?></td>
                                <td><a href="<?php echo e(route('eon.laravellti.cats.delete', $category['id'])); ?>" class="btn btn-danger btn-xs">Delete</a></td>
                            </tr>
