...
<iframe class="lti_frameResize" name="basicltiLaunchFrame" id="basicltiLaunchFrame" src="" scrolling="yes"  frameborder="0" style="overflow:hidden;height:100%;width:100%" height="100%" width="100%" transparency>
    <p>frames_required</p>
</iframe>
