...
<div class="dropdown">
<!-- <button onclick="myFunction()" class="dropbtn">Plot Graph</button> -->
  <div id="myDropdown" class="dropdown-content " >
  <form  >
   <div>
    A (x)<input type="text" id="Axposition" name="Axposition" value="1" onchange="XX()" class="col-md-3">
    A (y) <input type="text" id="Ayposition" name="Ayposition" value="0" onchange="XX()" class="col-md-3">
</div>
<div>
    B (x)<input type="text" id="Bxposition" name="Bxposition" value="-1" onchange="XX()" class="col-md-3">
    B (y) <input type="text" id="Byposition" name="Byposition" value="0" onchange="XX()" class="col-md-3">
</div>
<div>
    C (x)<input type="text" id="Cxposition" name="Cxposition" value="0.2" onchange="XX()" class="col-md-3">
    C (y) <input type="text" id="Cyposition" name="Cyposition" value="1.5" onchange="XX()" class="col-md-3">
</div>
...
// alert(firstX + " " + " " + firstY);
    ...
    var board = JXG.JSXGraph.initBoard('box2', {boundingbox: [-7, 7, 7, -7], keepaspectratio:true, showcopyright: false, shownavigation: false});
