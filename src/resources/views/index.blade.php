...
@section('content')
    <div class="col-sm-12">
        ...
        <div class="row">
            ...
            @foreach($graphs as $tool)

                <div class="app-item col-xs-3" id="app-listjs">
                    <div class="app-contents list">
                        <div class="app-details">
                            <h5 style="border-bottom:2px dashed #ccc;background:#e2e3ef;padding:3px; margin:0" class="title">{!! $tool['name'] !!}</h5>
                            {{--<p  style="font-size:10px; height:50px; overflow:hidden" class="app-description">{{ $tool['code'] }}</p>--}}
                            <div class="pull-bottom-left">
                                <a data-context="{{$tool['id']}}" class="appitem btn unisa-black-btn btn-sm"
                                   role="button"><i class="fa fa-circle-o-notch" aria-hidden="true"></i>&nbsp;Insert
                                    Graph</a>
                            <!-- href="{{ route('lecturer.graphstore.init', $tool['id']) }}" -->
                            </div>
                        </div>
                    </div>
                </div>
