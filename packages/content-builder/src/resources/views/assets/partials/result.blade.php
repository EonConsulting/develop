<div class="results-entry shadow">
    ...
    <div class="results-entry-actions">
        ...
        <a href="#" id="{{ $item['id'] }}" class="editEntry" data-asset-id="{{ $item['id'] }}"><i class="fa fa-pencil-square-o"></i></a>
        <a href="#" id="{{ $item['id'] }}" class="previewEntry" data-asset-id="{{ $item['id'] }}>"><i class="fa fa-eye"></i></a>
    </div>
</div>