                ...
                <div class="row">
                    <div class="install-button">
                        <div class="form-group">
                            <a href="{{ route('eon.laravellti.install') }}" class="btn-install btn btn-primary"><span class="glyphicon glyphicon-plus-sign"></span> Install App</a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div>
                            <div class="btn-entry-container basic-clearfix">
                                <a href="{{url('/eon/lti/appstore/launch/<% tool.context_id %>')}}" class="btn-entry btn-entry-view" role="button" title="Open">
                                    <span class="glyphicon glyphicon-open"></span>
                                </a>
                                <a href="#" class="btn-entry btn-entry-view" role="button" title="Configure">
                                    <span class="glyphicon glyphicon-cog"></span>
                                </a>
                                <a href="{{url('/eon/lti/delete/<% tool.context_id %>')}}" class="btn-entry btn-entry-delete" role="button" title="Delete">
