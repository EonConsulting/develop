<div class="results-entry shadow">
    ...
    <div class="results-entry-actions">
        <a href="#" class="deleteEntry" data-asset-id="{{ $item['id'] }}"><i class="fa fa-trash-o"></i></a>
        <a href="#" class="editEntry" data-asset-id="{{ $item['id'] }}"><i class="fa fa-pencil-square-o"></i></a>
